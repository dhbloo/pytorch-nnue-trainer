...
class ResNet(nn.Module):
    def __init__(self, num_blocks, dim_feature, head_type="v0", input_type="basic", activation_first=False):
        super().__init__()
        ...
        self.conv_trunk = nn.Sequential(
            *[ResBlock(dim_feature, norm="bn", activation_first=activation_first) for i in range(num_blocks)]
        )
